  ...
  return (
    <div className="bg-[#131313] flex flex-row basis-1/12">
      <div className="basis-1/2 flex flex-row">
        <button className="flex flex-row basis-[12%] items-center justify-items-center ml-2" onClick={onCam}>
        ...
        {bot === 'ros' ? (<button className="basis-[12%] flex flex-row items-center justify-items-center mt-2" onClick={onLidar}>
      ...
      <div className="basis-1/2 flex flex-row-reverse items-center justify-items-center">
        ...
        <div className="flex flex-row basis-[80%]">
          <button onClick={onEditor} className={`flex flex-row basis-[25%] items-center  ${oxanium.className} ${nav==="editor"?'bg-[#1e1e1e] border-t-2 border-[#007acc]':''}`}>
          ...
          <button onClick={onOutput} className={`flex flex-row basis-[25%] items-center ${oxanium.className} ${nav!=="editor"?'bg-[#1e1e1e] border-t-2 border-[#007acc]':''}`}>
